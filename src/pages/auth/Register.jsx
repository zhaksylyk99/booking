...
import regImg from '../../assets/img/auth/register.png';
...
function Register() {
    ...
    return (
        <div className="">
            ...
            <motion.div
                className="flex flex-col items-center relative  top-1/2 "
                variants={containerVariants}
                initial="hidden"
                animate="visible"
            >
                <motion.div className="mb-[10px]" variants={childVariants}>
                    <div className="text-[#169C89] font-medium text-[26px] leading-7     ">Регистрация</div>
                    <div className="text-[#999999] text-[18px]">Создай аккаунт, чтобы пройти дальше.</div>
                </motion.div>
                <motion.div className="flex flex-col gap-y-[10px]" variants={childVariants}>
                    ...
                    <motion.button
                        className="bg-[#169C89] text-white w-[343px] h-[58px] text-[20px] mt-[20px] rounded-md"
            ...
            >
                <div className="text-[#999999] text-[18px]">Уже есть аккаунт?</div>
                <Link to="/auth/login" className="text-[#169C89] text-[18px]">
                    Войти
                </Link>
            </motion.div>
        </div>
